...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="<?= base_url('admin/profile'); ?>" class="d-block"><?= $this->data->nama; ?></a>
					</div>
				</div>
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item">
							<a href="<?= base_url('admin'); ?>" id="dashboard" class="nav-link">
						...
						<li class="nav-item has-treeview" id="master">
							...
							<ul class="nav nav-treeview ml-3">
								<li class="nav-item">
									<a href="<?= base_url('admin/list_admin'); ?>" id="l-admin" class="nav-link">
										<i class="far fa-user nav-icon"></i>
										<p>List Admin</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?= base_url('admin/list_siswa'); ?>" id="l-siswa" class="nav-link">
										<i class="fas fa-users nav-icon"></i>
										<p>List Siswa</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?= base_url('admin/list_buku'); ?>" id="l-buku" class="nav-link">
						...
						<li class="nav-item has-treeview" id="riwayat">
							...
							<ul class="nav nav-treeview ml-3">
								<li class="nav-item">
									<a href="<?= base_url('admin/peminjaman'); ?>" id="r-peminjaman" class="nav-link">
										<i class="fas fa-arrow-circle-up nav-icon"></i>
										<p>Riwayat Peminjaman</p>
									</a>
								</li>
								<li class="nav-item">
									<a href="<?= base_url('admin/pengembalian'); ?>" id="r-pengembalian" class="nav-link">
		...
		<footer class="main-footer">
			<strong>&copy; <a href="<?= base_url('admin'); ?>">PERPUSTAKAAN KANDELA</a></strong>
		</footer>
